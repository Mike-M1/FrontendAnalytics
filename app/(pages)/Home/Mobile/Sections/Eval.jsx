...
export default function MobileEval({ isOpen, onClose }) {
  ...
  return (
    ...
    >
      <div 
        className="bg-white rounded-2xl shadow-2xl w-fit h-fit relative overflow-hidden border border-gray-200 p-5 m-[10px]"
        ...
        <div className="p-5 flex flex-col">
          <div className="mb-6 text-center flex-shrink-0">
            ...
            <div className={`transition-opacity duration-300 ${isTransitioning ? 'opacity-0' : 'opacity-100'}`}>
              <h1 className="text-2xl font-light text-gray-900 leading-tight" style={{fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, sans-serif'}}>

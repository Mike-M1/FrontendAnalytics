...
export async function POST(request) {
    ...
    const response = await client.responses.create({
        model: "gpt-5",
        input: `How to Think: You receive a question and an answer from the user. I need you to think about the question and really think about the answer and I want you to answer the question: If this is true then is this true? And based on what you deduce to be true ask another question where what you deduced to be true is implied as true in the new/next question. Question : ${Question} Answer:${Answer} `,
